...
\begin{tabular}{|L{.58\textwidth}|p{.365\textwidth}|}
   \hline
   \multicolumn{2}{|c|}{\hfsize\bfseries\@docTypeTitle} \\
   \hline
...
% Chnage the space between dotted lines
...
\setlength\cftfignumwidth{42pt}
\setlength\cfttabnumwidth{42pt}
...
\else
   ...
   \multido{\ii=1+2}{10}{%
    ...
    \else
       ...
       \textbf{\docAuthorName(\ii)} \hfill \textbf{Date} \break
       ...
       \else
          ...
          \ifdefstring{\@docSigned}{true}{
            ...
            \vspace{6pt} \hrule \vspace{5pt}
            \textbf{\docAuthorName(\iinext)} \hfill \textbf{Date} \break
...
\else
   ...
   \else
    ...
    \vspace{6pt} \hrule \vspace{5pt}
    \textbf{\docApproverName(\ii)} \hfill \textbf{Date} \break
    ...
    \else
       ...
       \ifdefstring{\@docSigned}{true}{
         ...
         \vspace{6pt} \hrule \vspace{5pt}
         \textbf{\docApproverName(\iinext)} \hfill \textbf{Date} \break
